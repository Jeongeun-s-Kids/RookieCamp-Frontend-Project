...
insert into product(name, type, category, link,icon,content) values('AI 방역로봇', 'food','smart','https://enterprise.kt.com/pd/P_PD_AI_RB_005.do','airCleanerAI.png','감염의 위험과 함께하는 엔데믹의 시대에 일상의 안전을 지키는 AI 로봇 기반의 새로운 방역 패러다임');
...
insert into product(name, type, category, link,icon,content) values('상권분석솔루션', 'food','marketing','https://enterprise.kt.com/pd/P_PD_AI_BD_002.do','sanggunbunsuck_solution.png','전국 상업용 건물 및 사업체 정보를 기반으로 매장 매출 분석 및 출점 후보지 분석을 지원하는 상권분석 솔루션');
insert into product(name, type, category, link,icon,content) values('타겟마케팅', 'food','marketing','https://enterprise.kt.com/pd/P_PD_AI_BD_004.do','target_marketing.png','고객의 이용패턴을 분석하여, 최적의 고객군에게 차별화된 서비스를 제공하는 타겟 마케팅 서비스');
insert into product(name, type, category, link,icon,content) values('잘나가게', 'food','marketing','https://enterprise.kt.com/pd/P_PD_AI_BD_006.do','jalnagagae.png','유용한 상권 정보와 영업 TIP을 보내주는 예비창업자/소상공인 대상 문자 알림 서비스');